...
_deps = [
    ...
    "isort>=5.12.0",
    "liger_kernel==0.5.2",
    "lighteval @ git+ssh://git@github.com/huggingface/lighteval.git@4f381b352c0e467b5870a97d41cb66b487a2c503#egg=lighteval[math]",
    ...
    "torch>=2.5.1",
    "transformers @ git+ssh://git@github.com/huggingface/transformers.git@336dc69d63d56f232a183a3e7f52790429b871ef",
    "trl==0.14.0",
    "vllm==0.6.6.post1",
    "wandb>=0.19.1",
    "pillow",
